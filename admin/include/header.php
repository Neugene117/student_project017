                        ...
                        <?php foreach ($notifications as $notification): ?>
                            <div class="notification-item <?php echo $notification['is_read'] == 0 ? 'unread' : ''; ?>">
                                ...
                                <a href="notifications.php" class="notification-link"
                                    style="display:flex; align-items:flex-start; gap:12px; text-decoration:none; color:inherit; width:100%;">
                                    ...
                                    <div class="notification-content">
                                        <p class="notification-text"><?php echo htmlspecialchars($notification['message']); ?>
                                        </p>
                                        <span
