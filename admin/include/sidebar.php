...
if (isset($conn)) {
    ...
    if ($res_eq) $sidebar_equipment_count = mysqli_fetch_assoc($res_eq)['count'];
    ...
    if ($res_maint) $sidebar_maintenance_count = mysqli_fetch_assoc($res_maint)['count'];
    ...
    if ($res_bd) $sidebar_breakdown_count = mysqli_fetch_assoc($res_bd)['count'];
}
?>
