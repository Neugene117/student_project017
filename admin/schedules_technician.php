...
$sql = "SELECT 
        ...
        AND NOT EXISTS (
            SELECT 1 FROM breakdown 
            WHERE breakdown.equipment_id = ms.equipment_id 
            AND breakdown.statuss = 'Open'
        )
...
<body>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="equipment-image-cell">
                                            <?php if (!empty($schedule['equipment_image'])): ?>
                                                <img src="../uploads/equipment/<?php echo htmlspecialchars($schedule['equipment_image']); ?>"
                                                    alt="<?php echo htmlspecialchars($schedule['equipment_name']); ?>"
                                                    class="equipment-image">
                                            <?php else: ?>
                                                <div class="equipment-image"
                                                    style="display: flex; align-items: center; justify-content: center; background: #f3f4f6; color: #d1d5db;">
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 8px;">
                                            ...
                                            <button type="button" class="btn-action btn-breakdown" style="background: #ef4444;"
                                                data-equipment-id="<?php echo $schedule['equipment_id']; ?>"
                                                data-equipment-name="<?php echo htmlspecialchars($schedule['equipment_name']); ?>"
    ...
    <div id="fillMaintenanceModal" class="modal"
        style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 1000; justify-content: center; align-items: center;">
        <div class="modal-content"
            style="background: white; padding: 24px; border-radius: 12px; width: 90%; max-width: 500px; position: relative;">
            <span class="close-modal"
                style="position: absolute; top: 16px; right: 16px; font-size: 24px; cursor: pointer; color: #6b7280;">&times;</span>
            ...
            <form method="POST" action="" id="maintenanceForm">
                ...
                <div style="margin-bottom: 16px;">
                    <label
                        style="display: block; margin-bottom: 8px; color: #374151; font-weight: 500;">Equipment</label>
                    <input type="text" id="modal_equipment_name" readonly
                        style="width: 100%; padding: 10px; background: #f3f4f6; border: 1px solid #d1d5db; border-radius: 6px;">
                </div>

                <div style="margin-bottom: 16px;">
                    <label style="display: block; margin-bottom: 8px; color: #374151; font-weight: 500;">Description of
                        Work</label>
                ...
                <div style="margin-bottom: 24px;">
                    <label style="display: block; margin-bottom: 8px; color: #374151; font-weight: 500;">Cost
                        (RWF)</label>
                ...
                <div style="display: flex; gap: 12px; justify-content: flex-end;">
                    <button type="button" class="btn-cancel"
                        style="padding: 10px 20px; border: 1px solid #d1d5db; background: white; border-radius: 6px; cursor: pointer;">Cancel</button>
                    <input type="hidden" name="submit_maintenance" value="1">
                    <button type="submit" name="submit_maintenance"
                        style="padding: 10px 20px; border: none; background: #2563eb; color: white; border-radius: 6px; cursor: pointer; font-weight: 600;">Submit
                        Report</button>
                </div>
            </form>
        </div>
    ...
    <div id="breakdownModal" class="modal"
        ...
        <div class="modal-content"
            style="background: white; padding: 24px; border-radius: 12px; width: 90%; max-width: 500px; position: relative;">
            <span class="close-breakdown-modal"
                style="position: absolute; top: 16px; right: 16px; font-size: 24px; cursor: pointer; color: #6b7280;">&times;</span>
            ...
            <form method="POST" action="" id="breakdownForm">
                ...
                <input type="hidden" name="submit_breakdown" value="1">

                <div style="margin-bottom: 16px;">
                    <label
                        style="display: block; margin-bottom: 8px; color: #374151; font-weight: 500;">Equipment</label>
                    <input type="text" id="breakdown_equipment_name" readonly
                        style="width: 100%; padding: 10px; background: #f3f4f6; border: 1px solid #d1d5db; border-radius: 6px;">
                </div>

                <div style="margin-bottom: 16px;">
                    <label style="display: block; margin-bottom: 8px; color: #374151; font-weight: 500;">Issue
                        Description</label>
                    <textarea name="description" required rows="4"
                        style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 6px; resize: vertical;"
                ...
                <div style="margin-bottom: 24px;">
                    <label
                        style="display: block; margin-bottom: 8px; color: #374151; font-weight: 500;">Priority</label>
                ...
                <div style="display: flex; gap: 12px; justify-content: flex-end;">
                    <button type="button" class="btn-cancel-breakdown"
                        style="padding: 10px 20px; border: 1px solid #d1d5db; background: white; border-radius: 6px; cursor: pointer;">Cancel</button>
                    <button type="submit"
                        style="padding: 10px 20px; border: none; background: #dc2626; color: white; border-radius: 6px; cursor: pointer; font-weight: 600;">Report
                        Issue</button>
                </div>
            </form>
        </div>
    ...
    <script>
        ...
        document.querySelectorAll('.btn-action[data-schedule-id]').forEach(button => {
